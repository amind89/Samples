...
# -*- coding: utf-8 -*-
"""
Created on Fri Sep  6 09:22:57 2019

@author: amin
"""

#import DEC from DECfunc
#import numpy
...
def Clust(sub):
    ...
    subid1 = '/p/himmelbach/amin/9T_MNI/150Cluster_Labels_DEC_no-sub-{:02d}_.txt'.format(sub)
...
#            count += 1
#            
#    dec = DEC(dims=[Y.shape[-1], 500, 500, 2000, 120], n_clusters=150, init=init)
#
#    dec.pretrain(x=Y, y=None, optimizer=pretrain_optimizer,
...
#    
#    y_pred1 = dec.fit(Y, y=None, tol=tol, maxiter=maxiter, batch_size=batch_size,
#                     update_interval=update_interval, save_dir=save_dir)
#    
#    np.savetxt(subid1, y_pred1)
    
    y_pred1 = pd.read_csv(subid1, header=None).values
    
    
    
    subid1 = '/p/himmelbach/amin/9T_MNI/150Cluster_Labels_DEC_sub-{:02d}_notinf.txt'.format(sub)
...
#    Y[:,count] = y_pred1
    ...
    y_pred2 = dec.fit(Y, y=None, tol=tol, maxiter=maxiter, batch_size=batch_size,
                     update_interval=update_interval, save_dir=save_dir)
